   ...
   Plugin.prototype =
           {
              ...
              initHours: function ()
              {
                 ...
                 for (var i = 0; i < 12; i++)
                 {
                    ...
                    var svgHourCircle = this.createSVGElement("circle", {'id': 'h-' + i, 'class': 'dtp-select-hour', 'style': 'cursor:pointer', r: '22', cx: x, cy: y, fill: fill, 'data-hour': i});
                    ...
                    } else
                    {
                       svgHourCircle.addEventListener('click', this._onSelectHour.bind(this));
                        ...
                        //};
                        //svgHourCircle.addEventListener('mousemove', function (e) {
                        //    console.log('move');
                        //    self._onSelectHour.bind(self);
                        //    simulateClick(svgHourCircle);
                        //});
                        //svgHourCircle.addEventListener('mousedown', function () {
                        //    svgHourCircle.addEventListener('mousemove', function (e) {
                        //        console.log('move');
                        //        e.click();
                        //    } );
                        //});
                        //svgHourText.addEventListener('mousemove', function (e) {
                        //    console.log('move');
                        //    self._onSelectHour.bind(self);
                        //    //simulateClick(svgHourText);
                        //});
                        //svgHourText.addEventListener('mousedown', function () {
                        //    svgHourText.addEventListener('mousemove', function (e) {
                        //        console.log('move');
                        //        e.click();
                        //    });
                 ...
                 if (!this.params.shortTime)
                 {
                    for (var i = 0; i < 12; i++)
                    {
                       ...
                       var svgHourCircle = this.createSVGElement("circle", {'id': 'h-' + (i + 12), 'class': 'dtp-select-hour', 'style': 'cursor:pointer', r: '22', cx: x, cy: y, fill: fill, 'data-hour': (i + 12)});
